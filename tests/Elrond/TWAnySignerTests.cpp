...
TEST(TWAnySignerElrond, SignJSON) {
    ...
    auto input = STRING((boost::format(R"({"transaction" : {"data":"foo","value":"0","nonce":0,"receiver":"%1%","sender":"%2%","gasPrice":1000000000,"gasLimit":50000,"chainId":"1","version":1}})") % ACCOUNT_B_BECH32 % ACCOUNT_A_BECH32).str().c_str());
    auto privateKey = DATA(ACCOUNT_A_SEED_HEX);
