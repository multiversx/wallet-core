...
class TestBinanceTestnetAddress {
    ...
    fun testAddress() {
        ...
        val address = AnyAddress(pubkey, CoinType.BINANCETESTNET)
        val expected = AnyAddress("__EXPECTED_RESULT_ADDRESS__", CoinType.BINANCETESTNET)
